...
{	
	public class InstructionsForJumping : MonoBehaviour 
	{
		...
		protected virtual void Start () 
		{
			...
			{ 
                if (LevelManagerForJumpingGame.Instance.InstructionsText != "")
                {
                    InstructionsText.text = LevelManagerForJumpingGame.Instance.InstructionsText;
