...
{	
	...
	/// </summary>
	public class GameManagerForJumpingGame : Singleton<GameManagerForJumpingGame>
	{			
		...
		public virtual void Reset()
		{
			Points = 0;
			TimeScale = 1f;
			GameManagerForJumpingGame.Instance.SetStatus(GameStatus.GameInProgress);
	    ...
	    protected virtual IEnumerator IncrementScore()
		{
	        while (true)
	        {
	            if ((GameManagerForJumpingGame.Instance.Status == GameStatus.GameInProgress) && (_pointsPerSecond!=0) )
	            {
